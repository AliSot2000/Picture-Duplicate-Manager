...
class DatabaseViews(Enum):
    ...
    PRESENCE_UPDATE_TILE = 41
    # Open a given image, with carousel and metadata (has the same metadata like MAIN_BIG_SCREEN with an extra field now present or now missing)
    PRESENCE_UPDATE_BIG_SCREEN = 42