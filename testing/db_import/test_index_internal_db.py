...
class TestImportInternalNewFiles(BaseInternalImportTable):
    ...
    def test_import_hash_dir_rename_move(self):
        ...
        self.api.import_internal_new_files(tbl=tbl, rename=True, move=True)
    ...
    def test_import_hash_dir_no_rename_move(self):
        ...
        self.api.import_internal_new_files(tbl=tbl, rename=False, move=True)
    ...
    def test_import_hash_dir_rename_no_move(self):
        ...
        self.api.import_internal_new_files(tbl=tbl, rename=True, move=False)
    ...
    def test_import_hash_dir_no_rename_no_move(self):
        ...
        self.api.import_internal_new_files(tbl=tbl, rename=False, move=False)
