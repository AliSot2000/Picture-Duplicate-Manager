...
class TestAPIPrepareDirectoryForImport(PrepareDirForImportBaseClass):
    """
    Fully test the api.prepare_directory_for_import function.
    """
    # INFO: api.verify_external_dir is tested in import_aux_tests.
