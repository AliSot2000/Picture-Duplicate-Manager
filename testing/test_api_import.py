...
class TestAPIPerformImport(unittest.TestCase):
    ...
    def check_dynamic_dirs(self, rel_paths: List[str]):
        ...
        db_paths = [
            ...
            "1990/10/01/1990-10-01T12-00-00_0134.png",      # Needed for matching algo during import
            "1990/10/01/1990-10-01T12-00-01_0137.png",      # Needed for matching algo during import
            "1990/10/01/1990-10-01T12-00-02_0135.png",      # Needed for matching algo during import
            "1990/10/01/1990-10-01T12-00-03_0138.png",      # Needed for matching algo during import
            "1990/10/01/1990-10-01T12-00-04_0133.png",      # Needed for matching algo during import
            "1990/10/01/1990-10-01T12-00-05_0136.png",      # Needed for matching algo during import
            "1990/10/02/1990-10-02T12-00-01_0142.png",      # Needed for matching algo during import
            "1990/10/02/1990-10-02T12-00-02_0140.png",      # Needed for matching algo during import
            "1990/10/02/1990-10-02T12-00-03_0143.png",      # Needed for matching algo during import
            "1990/10/02/1990-10-02T12-00-04_0139.png",      # Needed for matching algo during import
            "1990/10/02/1990-10-02T12-00-05_0141.png",      # Needed for matching algo during import
            "1990/10/03/1990-10-03T12-00-02_0145.png",      # Needed for matching algo during import
            "1990/10/03/1990-10-03T12-00-03_0147.png",      # Needed for matching algo during import
            "1990/10/03/1990-10-03T12-00-04_0144.png",      # Needed for matching algo during import
            "1990/10/03/1990-10-03T12-00-05_0146.png",      # Needed for matching algo during import
            "1990/10/04/1990-10-04T12-00-03_0150.png",      # Needed for matching algo during import
            "1990/10/04/1990-10-04T12-00-04_0148.png",      # Needed for matching algo during import
            "1990/10/04/1990-10-04T12-00-05_0149.png",      # Needed for matching algo during import
            "1990/10/05/1990-10-05T12-00-04_0151.png",      # Needed for matching algo during import
            "1990/10/05/1990-10-05T12-00-05_0152.png",      # Needed for matching algo during import
            "1990/10/06/1990-10-06T12-00-05_0153.png",      # Needed for matching algo during import
            "1990/10/07/1990-10-07T12-00-00_0154.png",      # Needed for matching algo during import
    ...
    def check_rel_custom_dir(self, rel_paths: List[str], custom_target_dir: str):
        ...
        db_files = [
            ...
            "1990-10-01T12-00-00_0134.png",     # Needed for matching algo during import
            "1990-10-01T12-00-01_0137.png",     # Needed for matching algo during import
            "1990-10-01T12-00-02_0135.png",     # Needed for matching algo during import
            "1990-10-01T12-00-03_0138.png",     # Needed for matching algo during import
            "1990-10-01T12-00-04_0133.png",     # Needed for matching algo during import
            "1990-10-01T12-00-05_0136.png",     # Needed for matching algo during import
            "1990-10-02T12-00-01_0142.png",     # Needed for matching algo during import
            "1990-10-02T12-00-02_0140.png",     # Needed for matching algo during import
            "1990-10-02T12-00-03_0143.png",     # Needed for matching algo during import
            "1990-10-02T12-00-04_0139.png",     # Needed for matching algo during import
            "1990-10-02T12-00-05_0141.png",     # Needed for matching algo during import
            "1990-10-03T12-00-02_0145.png",     # Needed for matching algo during import
            "1990-10-03T12-00-03_0147.png",     # Needed for matching algo during import
            "1990-10-03T12-00-04_0144.png",     # Needed for matching algo during import
            "1990-10-03T12-00-05_0146.png",     # Needed for matching algo during import
            "1990-10-04T12-00-03_0150.png",     # Needed for matching algo during import
            "1990-10-04T12-00-04_0148.png",     # Needed for matching algo during import
            "1990-10-04T12-00-05_0149.png",     # Needed for matching algo during import
            "1990-10-05T12-00-04_0151.png",     # Needed for matching algo during import
            "1990-10-05T12-00-05_0152.png",     # Needed for matching algo during import
            "1990-10-06T12-00-05_0153.png",     # Needed for matching algo during import
            "1990-10-07T12-00-00_0154.png",     # Needed for matching algo during import
